...
GO
PRINT N'Creating [dbo].[DVIRPower]...';
...
CREATE TABLE [dbo].[DVIRPower] (
    ...
    [BodyDoors]             BIT          NULL,
    [OilLeak]               VARCHAR (20) NULL,
    [GreaseLeak]            VARCHAR (20) NULL,
    [CoolantLeak]           BIT          NULL,
    [FuelLeak]              BIT          NULL,
    [OtherGeneral]          VARCHAR (20) NULL,
    [OilLevel]              BIT          NULL,
    [CoolantLevel]          BIT          NULL,
    [Belts]                 VARCHAR (20) NULL,
    ...
    CONSTRAINT [PK_DVIRPower] PRIMARY KEY CLUSTERED ([DVIRPowerId] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Creating [dbo].[DVIRTowed]...';
...
CREATE TABLE [dbo].[DVIRTowed] (
    ...
    [ReviewingDriverName]   VARCHAR (30) NULL,
    [ReviewingDriverNumber] VARCHAR (10) NULL,
    CONSTRAINT [PK_DVIRTowed] PRIMARY KEY CLUSTERED ([DVIRTowedId] ASC) ON [PRIMARY]
) ON [PRIMARY];
